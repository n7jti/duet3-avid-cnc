...
G1 H1 X-605 Y-905 F1800 ; move quickly to X or Y endstop and stop there (first pass)
G1 H1 X-605             ; home X axis
G1 H1 Y-905             ; home Y axis
G1 X5 Y5 F6000          ; go back a few mm
G1 H1 X-605 F360        ; move slowly to X axis endstop once more (second pass)
G1 H1 Y-905             ; then move slowly to Y axis endstop
G1 H1 Z-180 F360        ; move Z down stopping at the endstop
